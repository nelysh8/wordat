...
app.post('/cartoon', function (req, res) {  
  ...
  async function main() {
    ...
    console.log(JSON.stringify(page.$('iframe[id="amuembedframe"]')));
    // await page.waitForFunction(() => {
    //     // ➎ 함수가 웹브라우저의 컨텍스트에서 실행되기 때문에 document 객체에 접근 가능
    //     return document.getElementsByClassName('item-comic-image');
  ...
  // const getHtml = async () => {
  //     try {
  //       return await axios.get("https://www.peanuts.com/");
  //     } catch (error) {
  //       console.error(error);
  //     }
  //   };    
  ...
  //   });
      ...
      // const $item = $('div.block-block'); 
      // // console.log($item.html());
      // const $content = $item.find('div.content');
      // console.log($content.html());
      // // const url = `https://entertainment.service.amuniversal.com/content/peanuts?client_code=${amuCustomerId}&sub_id=${amuSubId}&encrypted_url=
      
      // const cartoon_img = $content.find('iframe').attr('src');      
