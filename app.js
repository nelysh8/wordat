...
app.post('/websearch_cambrg', function (req, res) {
  ...
  .then(html => {
      ...
      const $wordhead = $('#page-content > div.pr.entry-body > div.di.english-korean > div > span > div:nth-child(1) > span > div');
      const $pronounce = $('#page-content > div.pr.entry-body > div.di.english-korean > div > span > div:nth-child(1) > span > div > span:nth-child(5)');
